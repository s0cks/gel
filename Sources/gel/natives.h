...
// uv lib
//----------------------------------------------------------------------
_DECLARE_NATIVE_PROCEDURE(uv_close, "uv:close");
_DECLARE_NATIVE_PROCEDURE(uv_run, "uv:run");
_DECLARE_NATIVE_PROCEDURE(uv_alive, "uv:alive");
_DECLARE_NATIVE_PROCEDURE(uv_stop, "uv:stop");
//----------------------------------------------------------------------
