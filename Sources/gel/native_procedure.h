...
class NativeFn : public Fn {
 ...
 public:
  ...
  static auto Find(S symbol) -> NativeFn*;
...
// #define _DECLARE_NATIVEFN_FN(Name, Sym) _DECLARE_NATIVE_PROCEDURE(native_fn_##Name, "native-fn:" Sym)
// #define DECLARE_NATIVEFN_FN(Name)       _DECLARE_NATIVEFN_FN(Name, #Name)

// _DECLARE_NATIVEFN_FN(get_owner, "get-owner");
// _DECLARE_NATIVEFN_FN(get_symbol, "get-symbol");
// _DECLARE_NATIVEFN_FN(get_docs, "get-docs");

// #undef DECLARE_NATIVEFN_FN
// #undef _DECLARE_NATIVEFN_FN
// }  // namespace proc
}  // namespace gel
