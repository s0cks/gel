#ifndef SCM_TO_STRING_HELPER_H
#define SCM_TO_STRING_HELPER_H
...
class ToStringHelperBase {
 ...
 public:
  ...
  void AddField(const std::string& name, const scm::Object* value);
